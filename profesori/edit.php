...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-multiselect/0.9.13/css/bootstrap-multiselect.css" />
    <title>Editeaza informatiile</title>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Profesor" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4>
                      <?php echo $rows['nume']; ?> <?php echo $rows['prenume'];?>
                      </h4>
                      <p class="text mb-1">Profesor</p>
...
?>
              <div class="card mt-3">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center ">
                    <a class="link" href="profesor.php"><b>Dashboard</b></a>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center ">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                      ...
                      <br>
                      <form method="post"  action="edit_profesor_nume.php">
                        ...
                        <form method="post"  action="edit_profesor_prenume.php">
                        ...
                        <form method="post"  action="edit_profesor_email.php">
                        ...
                        </form> <form method="post"  action="edit_profesor_parola.php">
